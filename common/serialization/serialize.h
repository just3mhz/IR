...
template <>
auto read(std::istream& is, bool& value) -> std::size_t
{
    const auto pos = is.tellg();
...
template <>
auto read(std::istream& is, std::string& value) -> std::size_t
{
    const auto pos = is.tellg();
...
template <>
auto read(std::istream& is, Serializable& value) -> std::size_t
{
